...
public class HomeController {
    ...
    public String newUserPost(HttpServletRequest request,
        ...
        String encryptedPassword = SecurityUtility.passwordEncoder()
                .encode(password);
        ...
        SimpleMailMessage email = this.mailConstructor.constructResetTokenEmail(
    ...
    public String newUser(
        ...
        PasswordResetToken passToken = this.userService
        ...
        UserDetails userDetails = this.userSecurityService
